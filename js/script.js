		...
		if ($.cookie('gritter_show')) {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Welcome to DutaRESTO!',
                    // (string | mandatory) the text inside the notification
                    text: 'This system can make you bussines bigger than your expect!',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'DutaRESTO!',
                    // (string | mandatory) the text inside the notification
                    text: 'DutaRESTO is easily to use, lightweight and has a great User Experience.',
                    // (string | optional) the image to display on the left
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'Rent DutaRESTO!',
                    // (string | mandatory) the text inside the notification
                    text: 'Rent DutaRESTO and get access to future system of POS. Rent now!',
                    // (string | optional) the image to display on the left
