...
class TTemplate{
  ...
  function TTemplate($template,$dir=""){
	global $config;
	...
	if($dir==""){
	  ...
	  $this->template->LoadTemplate($dir.$nTpl.".tpl",false);
	}
	$this->position = "left";
	$this->name = $template;
  }
...
class TSQLTemplate extends TTemplate{
  ...
  function TSQLTemplate($template,$dir=""){
  
	parent::TTemplate($template,$dir); 
  }
...
class TGridTemplate extends TTemplate{
  ...
  function TGridTemplate($template,$dir=""){
