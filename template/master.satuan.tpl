            ...
            <div class="box-title">
             ...
             <div class="box-body table-responsive">
                ...
                <input name='fkey' id='fkey' type='hidden' size=/>
                    ...
                    <tbody>
                        <tr>
                            <td>[grid_blk.cSatuan;noerr;block=tr]</td>
                            <td>[grid_blk.cAlias;noerr;block=tr]</td>
                            <td width="25" align="center">[var.button.E;if [var.button.E;noerr]=='valid';then <a href="#" title="Edit Data" class="back" onClick="window.location = '?m=[var.~moduleid;noerr]&mode=form&key=[grid_blk.cSatuan;noerr]'"><span class="fa fa-eject"></span></a>;else <span class="fa fa-eject"></span>]</td>
                            <td width="25" align="center">[var.button.D;if [var.button.D;noerr]=='valid';then <a href="#" title="Delete Data" class="back" onClick="ConfirmDelete('[grid_blk.cSatuan;noerr]')"><span class="fa fa-trash-o"></span></a>;else <span class="fa fa-trash-o"></span>]</td>
                        </tr>
                        <tr>
                          <td colspan="2">&nbsp;</td>
        ...
        <div class="box border primary">
            ...
            <div class="box-body">
               ...
               <form name="form" id="form" method="post" action="?m=[var.~moduleid;noerr][var.~page_url;noerr]">
                <input name='fkey' id='fkey' type='hidden' value='[grid_blk.cSatuan;noerr;]' size=/>
                    <div class="form-body">
                      	<div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label class="control-label">Unit Code</label>
                                    <input type="text" name="kode" id="kode" class="form-control" value="[grid_blk.cSatuan;noerr;]" [onshow; if [grid_blk.cSatuan;noerr;]!='';then 'disabled';else '']>
                                </div>
                            </div>
                        </div>
                      	<div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control" value="[grid_blk.cAlias;noerr;]">
                                </div>
                            </div>
                        </div>
                    </div>
