...
if($_POST['idpesan']!=""){
	...
	$sql .= "dt.cIdTamu, tm.vNmTamu, dt.cKdBarang, brg.vNamaBarang, dt.vQty, dt.vQtyKitchen, (dt.vQty-COALESCE(dt.vQtyKitchen,0)) as vQtySaldo, dt.cKeterangan ";
	...
	$sql .= "WHERE dt.cKdPesanan = '".$_POST['idpesan']."' AND (dt.vQty-COALESCE(dt.vQtyKitchen,0)) <> 0 ";
	$tpldt->SQL = $sql;
